...
class RangerCppClassWriter  extends RangerGenericClassWriter {
  ...
  writeFnCall(node ,ctx ,wr ) {
    if ( node.hasFnCall ) {
      ...
      for ( var i_100 = 0; i_100 < node.fnDesc.params.length; i_100++) {
        ...
        if ( i_100 >= (givenArgs_6.children.length) ) {
  ...
  writeClassHeader(node ,ctx ,wr ) {
    ...
    if ( (cl_11.extends_classes.length) > 0 ) {
      wr.out(" : ", false);
      for ( var i_104 = 0; i_104 < cl_11.extends_classes.length; i_104++) {
        var pName_4 = cl_11.extends_classes[i_104];
        wr.out("public ", false);
    ...
    wr.out("public :", true);
    wr.indent(1);
    for ( var i_108 = 0; i_108 < cl_11.variables.length; i_108++) {
      var pvar_6 = cl_11.variables[i_108];
    ...
    wr.out(" );", true);
    for ( var i_111 = 0; i_111 < cl_11.static_methods.length; i_111++) {
      var variant_7 = cl_11.static_methods[i_111];
      if ( i_111 == 0 ) {
    ...
    for ( var i_114 = 0; i_114 < cl_11.defined_variants.length; i_114++) {
      var fnVar_4 = cl_11.defined_variants[i_114];
      if ( i_114 == 0 ) {
        wr.out("/* instance methods */ ", true);
      }
      var mVs_4 = cl_11.method_variants[fnVar_4]
      for ( var i_121 = 0; i_121 < mVs_4.variants.length; i_121++) {
        var variant_12 = mVs_4.variants[i_121];
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    wr_6.out(" ) {", true);
    wr_6.indent(1);
    for ( var i_114 = 0; i_114 < cl_13.variables.length; i_114++) {
      var pvar_9 = cl_13.variables[i_114];
      var nn_18 = pvar_9.nameNode
    ...
    wr_6.indent(-1);
    wr_6.out("}", true);
    for ( var i_118 = 0; i_118 < cl_13.static_methods.length; i_118++) {
      var variant_12 = cl_13.static_methods[i_118];
    ...
    for ( var i_121 = 0; i_121 < cl_13.defined_variants.length; i_121++) {
      var fnVar_7 = cl_13.defined_variants[i_121];
      var mVs_7 = cl_13.method_variants[fnVar_7]
      for ( var i_128 = 0; i_128 < mVs_7.variants.length; i_128++) {
        var variant_16 = mVs_7.variants[i_128];
        wr_6.out("", true);
    ...
    for ( var i_127 = 0; i_127 < cl_13.static_methods.length; i_127++) {
      var variant_19 = cl_13.static_methods[i_127];
...
class RangerKotlinClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      for ( var i_108 = 0; i_108 < node.nsp.length; i_108++) {
        var p_28 = node.nsp[i_108];
        if ( i_108 > 0 ) {
          wr.out(".", false);
        }
        if ( (p_28.compiledName.length) > 0 ) {
          ...
          if ( (p_28.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_108])), false);
          }
        }
        if ( i_108 == 0 ) {
    ...
    for ( var i_113 = 0; i_113 < node.ns.length; i_113++) {
      var part_8 = node.ns[i_113];
      if ( i_113 > 0 ) {
        wr.out(".", false);
      }
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_113 = 0; i_113 < fnDesc.params.length; i_113++) {
      var arg_21 = fnDesc.params[i_113];
      if ( i_113 > 0 ) {
        wr.out(",", false);
      }
      wr.out(" ", false);
  ...
  writeFnCall(node ,ctx ,wr ) {
    if ( node.hasFnCall ) {
      ...
      for ( var i_115 = 0; i_115 < node.fnDesc.params.length; i_115++) {
        var arg_24 = node.fnDesc.params[i_115];
        if ( i_115 > 0 ) {
          wr.out(", ", false);
        }
        if ( (givenArgs_8.children.length) <= i_115 ) {
        ...
        var n_14 = givenArgs_8.children[i_115]
  ...
  writeNewCall(node ,ctx ,wr ) {
    if ( node.hasNewOper ) {
      ...
      if ( typeof(constr_9) !== "undefined" ) {
        for ( var i_117 = 0; i_117 < constr_9.params.length; i_117++) {
          var arg_26 = constr_9.params[i_117];
          var n_17 = givenArgs_11.children[i_117]
          if ( i_117 > 0 ) {
            wr.out(", ", false);
          }
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    wr_7.out(" {", true);
    wr_7.indent(1);
    for ( var i_119 = 0; i_119 < cl_14.variables.length; i_119++) {
      var pvar_8 = cl_14.variables[i_119];
    ...
    for ( var i_123 = 0; i_123 < cl_14.static_methods.length; i_123++) {
      var variant_12 = cl_14.static_methods[i_123];
      wr_7.out("", true);
      if ( variant_12.nameNode.hasFlag("main") ) {
        continue;
      }
    ...
    for ( var i_126 = 0; i_126 < cl_14.defined_variants.length; i_126++) {
      var fnVar_6 = cl_14.defined_variants[i_126];
      var mVs_6 = cl_14.method_variants[fnVar_6]
      for ( var i_133 = 0; i_133 < mVs_6.variants.length; i_133++) {
        var variant_17 = mVs_6.variants[i_133];
        wr_7.out("", true);
        wr_7.out("fun ", false);
        wr_7.out(" ", false);
    ...
    wr_7.indent(-1);
    wr_7.out("}", true);
    for ( var i_132 = 0; i_132 < cl_14.static_methods.length; i_132++) {
      var variant_20 = cl_14.static_methods[i_132];
      wr_7.out("", true);
...
class RangerCSharpClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      for ( var i_118 = 0; i_118 < node.nsp.length; i_118++) {
        var p_31 = node.nsp[i_118];
        if ( i_118 > 0 ) {
          wr.out(".", false);
        }
        if ( i_118 == 0 ) {
        ...
        if ( (p_31.compiledName.length) > 0 ) {
          ...
          if ( (p_31.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_118])), false);
          }
        }
      }
      return;
    ...
    for ( var i_123 = 0; i_123 < node.ns.length; i_123++) {
      var part_9 = node.ns[i_123];
      if ( i_123 > 0 ) {
        wr.out(".", false);
      }
      wr.out(this.adjustType(part_9), false);
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_123 = 0; i_123 < fnDesc.params.length; i_123++) {
      var arg_24 = fnDesc.params[i_123];
      if ( i_123 > 0 ) {
        wr.out(",", false);
      }
      wr.out(" ", false);
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    wr_8.indent(1);
    for ( var i_125 = 0; i_125 < cl_13.variables.length; i_125++) {
      var pvar_9 = cl_13.variables[i_125];
    ...
    for ( var i_129 = 0; i_129 < cl_13.static_methods.length; i_129++) {
      var variant_15 = cl_13.static_methods[i_129];
      wr_8.out("", true);
    ...
    for ( var i_132 = 0; i_132 < cl_13.defined_variants.length; i_132++) {
      var fnVar_7 = cl_13.defined_variants[i_132];
      var mVs_7 = cl_13.method_variants[fnVar_7]
      for ( var i_139 = 0; i_139 < mVs_7.variants.length; i_139++) {
        var variant_20 = mVs_7.variants[i_139];
        wr_8.out("", true);
        wr_8.out("public ", false);
    ...
    for ( var i_138 = 0; i_138 < import_list_2.length; i_138++) {
      var codeStr_2 = import_list_2[i_138];
...
class RangerScalaClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      for ( var i_126 = 0; i_126 < node.nsp.length; i_126++) {
        var p_34 = node.nsp[i_126];
        if ( i_126 > 0 ) {
          wr.out(".", false);
        }
        if ( (p_34.compiledName.length) > 0 ) {
          ...
          if ( (p_34.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_126])), false);
          }
        }
        if ( i_126 == 0 ) {
    ...
    for ( var i_131 = 0; i_131 < node.ns.length; i_131++) {
      var part_10 = node.ns[i_131];
      if ( i_131 > 0 ) {
        wr.out(".", false);
      }
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_131 = 0; i_131 < fnDesc.params.length; i_131++) {
      var arg_25 = fnDesc.params[i_131];
      if ( i_131 > 0 ) {
        wr.out(",", false);
      }
      wr.out(" ", false);
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    if ( cl_14.has_constructor ) {
      ...
      for ( var i_133 = 0; i_133 < constr_13.params.length; i_133++) {
        var arg_28 = constr_13.params[i_133];
        if ( i_133 > 0 ) {
          wr_9.out(", ", false);
        }
    ...
    wr_9.out(" {", true);
    wr_9.indent(1);
    for ( var i_137 = 0; i_137 < cl_14.variables.length; i_137++) {
      var pvar_10 = cl_14.variables[i_137];
    ...
    for ( var i_140 = 0; i_140 < cl_14.defined_variants.length; i_140++) {
      var fnVar_8 = cl_14.defined_variants[i_140];
      var mVs_8 = cl_14.method_variants[fnVar_8]
      for ( var i_147 = 0; i_147 < mVs_8.variants.length; i_147++) {
        var variant_17 = mVs_8.variants[i_147];
        wr_9.out("", true);
        wr_9.out("def ", false);
        wr_9.out(" ", false);
    ...
    for ( var i_146 = 0; i_146 < cl_14.static_methods.length; i_146++) {
      var variant_22 = cl_14.static_methods[i_146];
    ...
    for ( var i_149 = 0; i_149 < import_list_3.length; i_149++) {
      var codeStr_3 = import_list_3[i_149];
...
class RangerGolangClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      ...
      for ( var i_135 = 0; i_135 < node.nsp.length; i_135++) {
        var p_37 = node.nsp[i_135];
        if ( next_is_gs ) {
          if ( p_37.isProperty() ) {
            wr.out(".Get_", false);
            needs_par = true;
        ...
        if ( (p_37.compiledName.length) > 0 ) {
          ...
          if ( (p_37.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_135])), false);
          }
        }
        if ( needs_par ) {
          wr.out("()", false);
        ...
        if ( p_37.nameNode.hasFlag("optional") && (i_135 != ns_last) ) {
          wr.out(".value.(", false);
    ...
    for ( var i_140 = 0; i_140 < node.ns.length; i_140++) {
      var part_19 = node.ns[i_140];
      if ( i_140 > 0 ) {
        if ( (i_140 == 1) && b_was_static ) {
          wr.out("_static_", false);
        } else {
          wr.out(".", false);
        }
  ...
  WriteSetterVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      ...
      for ( var i_140 = 0; i_140 < node.nsp.length; i_140++) {
        var p_42 = node.nsp[i_140];
        if ( next_is_gs_4 ) {
          if ( p_42.isProperty() ) {
            wr.out(".Get_", false);
            needs_par_4 = true;
        ...
        if ( (p_42.compiledName.length) > 0 ) {
          ...
          if ( (p_42.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_140])), false);
          }
        }
        if ( needs_par_4 ) {
          wr.out("()", false);
    ...
    for ( var i_144 = 0; i_144 < node.ns.length; i_144++) {
      var part_25 = node.ns[i_144];
      if ( i_144 > 0 ) {
        if ( (i_144 == 1) && b_was_static_4 ) {
          wr.out("_static_", false);
        } else {
          wr.out(".", false);
        }
  ...
  goExtractAssign(value ,p ,ctx ,wr ) {
    ...
    for ( var i_144 = 0; i_144 < left.ns.length; i_144++) {
      var part_24 = left.ns[i_144];
      if ( next_is_gs_6 ) {
        if ( i_144 == len_5 ) {
          wr.out(".Set_", false);
      ...
      if ( (left.nsp.length) >= (i_144 + 1) ) {
        var pp_6 = left.nsp[i_144]
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_146 = 0; i_146 < fnDesc.params.length; i_146++) {
      var arg_27 = fnDesc.params[i_146];
      if ( i_146 > 0 ) {
        wr.out(", ", false);
      }
  ...
  writeNewCall(node ,ctx ,wr ) {
    if ( node.hasNewOper ) {
      ...
      if ( typeof(constr_15) !== "undefined" ) {
        for ( var i_148 = 0; i_148 < constr_15.params.length; i_148++) {
          var arg_30 = constr_15.params[i_148];
          var n_16 = givenArgs_10.children[i_148]
          if ( i_148 > 0 ) {
            wr.out(", ", false);
          }
  ...
  CustomOperator(node ,ctx ,wr ) {
    ...
    if ( ((cmd_3 == "=") || (cmd_3 == "push")) || (cmd_3 == "removeLast") ) {
      ...
      if ( left_4.hasParamDesc ) {
        ...
        for ( var i_150 = 0; i_150 < left_4.ns.length; i_150++) {
          var part_26 = left_4.ns[i_150];
          if ( next_is_gs_8 ) {
            if ( i_150 == len_8 ) {
              wr.out(".Set_", false);
          ...
          if ( (left_4.nsp.length) > i_150 ) {
            partDef_4 = left_4.nsp[i_150];
          }
          ...
          if ( (left_4.nsp.length) >= (i_150 + 1) ) {
            var pp_9 = left_4.nsp[i_150]
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    wr_10.indent(1);
    for ( var i_152 = 0; i_152 < cl_18.variables.length; i_152++) {
      var pvar_11 = cl_18.variables[i_152];
      this.writeStructField(pvar_11.node, ctx, wr_10);
      declaredVariable_2[pvar_11.name] = true
    }
    if ( (cl_18.extends_classes.length) > 0 ) {
      for ( var i_156 = 0; i_156 < cl_18.extends_classes.length; i_156++) {
        var pName_5 = cl_18.extends_classes[i_156];
        var pC_2 = ctx.findClass(pName_5)
        wr_10.out("// inherited from parent class " + pName_5, true);
        for ( var i_165 = 0; i_165 < pC_2.variables.length; i_165++) {
          var pvar_16 = pC_2.variables[i_165];
    ...
    wr_10.indent(1);
    for ( var i_162 = 0; i_162 < cl_18.variables.length; i_162++) {
      var p_54 = cl_18.variables[i_162];
    ...
    for ( var i_165 = 0; i_165 < cl_18.defined_variants.length; i_165++) {
      var fnVar_9 = cl_18.defined_variants[i_165];
      var mVs_9 = cl_18.method_variants[fnVar_9]
      for ( var i_172 = 0; i_172 < mVs_9.variants.length; i_172++) {
        var variant_20 = mVs_9.variants[i_172];
    ...
    if ( cl_18.has_constructor ) {
      ...
      for ( var i_171 = 0; i_171 < constr_18.params.length; i_171++) {
        var arg_32 = constr_18.params[i_171];
        if ( i_171 > 0 ) {
          wr_10.out(", ", false);
        }
    ...
    for ( var i_174 = 0; i_174 < cl_18.variables.length; i_174++) {
      var pvar_19 = cl_18.variables[i_174];
    ...
    for ( var i_177 = 0; i_177 < cl_18.variables.length; i_177++) {
      var pvar_22 = cl_18.variables[i_177];
      if ( pvar_22.nameNode.hasFlag("optional") ) {
        wr_10.out(("me." + pvar_22.compiledName) + " = new(GoNullable);", true);
      }
    }
    if ( (cl_18.extends_classes.length) > 0 ) {
      for ( var i_180 = 0; i_180 < cl_18.extends_classes.length; i_180++) {
        var pName_10 = cl_18.extends_classes[i_180];
        var pC_7 = ctx.findClass(pName_10)
        for ( var i_189 = 0; i_189 < pC_7.variables.length; i_189++) {
          var pvar_25 = pC_7.variables[i_189];
        ...
        for ( var i_194 = 0; i_194 < pC_7.variables.length; i_194++) {
          var pvar_32 = pC_7.variables[i_194];
    ...
    wr_10.out("}", true);
    this.thisName = "this";
    for ( var i_189 = 0; i_189 < cl_18.static_methods.length; i_189++) {
      var variant_25 = cl_18.static_methods[i_189];
    ...
    var declaredFn = []
    for ( var i_192 = 0; i_192 < cl_18.defined_variants.length; i_192++) {
      var fnVar_14 = cl_18.defined_variants[i_192];
      var mVs_14 = cl_18.method_variants[fnVar_14]
      for ( var i_199 = 0; i_199 < mVs_14.variants.length; i_199++) {
        var variant_28 = mVs_14.variants[i_199];
    ...
    if ( (cl_18.extends_classes.length) > 0 ) {
      for ( var i_198 = 0; i_198 < cl_18.extends_classes.length; i_198++) {
        var pName_13 = cl_18.extends_classes[i_198];
        var pC_10 = ctx.findClass(pName_13)
        wr_10.out("// inherited methods from parent class " + pName_13, true);
        for ( var i_207 = 0; i_207 < pC_10.defined_variants.length; i_207++) {
          var fnVar_17 = pC_10.defined_variants[i_207];
          var mVs_17 = pC_10.method_variants[fnVar_17]
          for ( var i_215 = 0; i_215 < mVs_17.variants.length; i_215++) {
            var variant_31 = mVs_17.variants[i_215];
    ...
    var declaredGetter = []
    for ( var i_207 = 0; i_207 < cl_18.variables.length; i_207++) {
      var p_58 = cl_18.variables[i_207];
    ...
    if ( (cl_18.extends_classes.length) > 0 ) {
      for ( var i_210 = 0; i_210 < cl_18.extends_classes.length; i_210++) {
        var pName_16 = cl_18.extends_classes[i_210];
        var pC_13 = ctx.findClass(pName_16)
        wr_10.out("// inherited getters and setters from the parent class " + pName_16, true);
        for ( var i_219 = 0; i_219 < pC_13.variables.length; i_219++) {
          var p_61 = pC_13.variables[i_219];
    ...
    for ( var i_216 = 0; i_216 < cl_18.static_methods.length; i_216++) {
      var variant_34 = cl_18.static_methods[i_216];
...
class RangerPHPClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      for ( var i_165 = 0; i_165 < node.nsp.length; i_165++) {
        var p_48 = node.nsp[i_165];
        if ( i_165 == 0 ) {
        ...
        if ( (p_48.compiledName.length) > 0 ) {
          ...
          if ( (p_48.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_165])), false);
          }
        }
      }
      return;
    ...
    for ( var i_170 = 0; i_170 < node.ns.length; i_170++) {
      var part_30 = node.ns[i_170];
      if ( i_170 > 0 ) {
        if ( (i_170 == 1) && b_was_static_5 ) {
          wr.out("::", false);
        } else {
          wr.out("->", false);
        }
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_170 = 0; i_170 < fnDesc.params.length; i_170++) {
      var arg_30 = fnDesc.params[i_170];
      if ( i_170 > 0 ) {
        wr.out(",", false);
      }
  ...
  writeFnCall(node ,ctx ,wr ) {
    if ( node.hasFnCall ) {
      ...
      ctx.setInExpr();
      for ( var i_172 = 0; i_172 < node.fnDesc.params.length; i_172++) {
        var arg_33 = node.fnDesc.params[i_172];
        if ( i_172 > 0 ) {
          wr.out(", ", false);
        }
        if ( (givenArgs_11.children.length) <= i_172 ) {
        ...
        var n_17 = givenArgs_11.children[i_172]
        this.WalkNode(n_17, ctx, wr);
      }
      ctx.unsetInExpr();
      wr.out(")", false);
  ...
  writeNewCall(node ,ctx ,wr ) {
    if ( node.hasNewOper ) {
      ...
      if ( typeof(constr_19) !== "undefined" ) {
        for ( var i_174 = 0; i_174 < constr_19.params.length; i_174++) {
          var arg_35 = constr_19.params[i_174];
          var n_20 = givenArgs_14.children[i_174]
          if ( i_174 > 0 ) {
            wr.out(", ", false);
          }
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    if ( (cl_20.extends_classes.length) > 0 ) {
      ...
      for ( var i_176 = 0; i_176 < cl_20.extends_classes.length; i_176++) {
        var pName_9 = cl_20.extends_classes[i_176];
    ...
    wr_11.out(" { ", true);
    wr_11.indent(1);
    for ( var i_180 = 0; i_180 < cl_20.variables.length; i_180++) {
      var pvar_17 = cl_20.variables[i_180];
    ...
    for ( var i_183 = 0; i_183 < cl_20.variables.length; i_183++) {
      var pvar_22 = cl_20.variables[i_183];
    ...
    wr_11.indent(-1);
    wr_11.out("}", true);
    for ( var i_186 = 0; i_186 < cl_20.static_methods.length; i_186++) {
      var variant_25 = cl_20.static_methods[i_186];
      wr_11.out("", true);
      if ( variant_25.nameNode.hasFlag("main") ) {
        continue;
      } else {
    ...
    for ( var i_189 = 0; i_189 < cl_20.defined_variants.length; i_189++) {
      var fnVar_12 = cl_20.defined_variants[i_189];
      var mVs_12 = cl_20.method_variants[fnVar_12]
      for ( var i_196 = 0; i_196 < mVs_12.variants.length; i_196++) {
        var variant_30 = mVs_12.variants[i_196];
        wr_11.out("", true);
    ...
    wr_11.indent(-1);
    wr_11.out("}", true);
    for ( var i_195 = 0; i_195 < cl_20.static_methods.length; i_195++) {
      var variant_33 = cl_20.static_methods[i_195];
...
class RangerJavaScriptClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef(node ,ctx ,wr ) {
    ...
    if ( (node.nsp.length) > 0 ) {
      for ( var i_177 = 0; i_177 < node.nsp.length; i_177++) {
        var p_53 = node.nsp[i_177];
        if ( i_177 > 0 ) {
          wr.out(".", false);
        }
        if ( i_177 == 0 ) {
        ...
        if ( (p_53.compiledName.length) > 0 ) {
          ...
          if ( (p_53.name.length) > 0 ) {
            ...
            wr.out(this.adjustType((node.ns[i_177])), false);
          }
        }
      }
      return;
    ...
    var b_was_static_6 = false
    for ( var i_182 = 0; i_182 < node.ns.length; i_182++) {
      var part_31 = node.ns[i_182];
      if ( i_182 > 0 ) {
        if ( (i_182 == 1) && b_was_static_6 ) {
          wr.out(".", false);
        } else {
          wr.out(".", false);
        }
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_182 = 0; i_182 < fnDesc.params.length; i_182++) {
      var arg_33 = fnDesc.params[i_182];
      if ( i_182 > 0 ) {
        wr.out(",", false);
      }
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    for ( var i_184 = 0; i_184 < cl_19.extends_classes.length; i_184++) {
      var pName_10 = cl_19.extends_classes[i_184];
      if ( i_184 == 0 ) {
    ...
    wr_12.out(" {", true);
    wr_12.indent(1);
    for ( var i_188 = 0; i_188 < cl_19.variables.length; i_188++) {
      var pvar_19 = cl_19.variables[i_188];
    ...
    for ( var i_191 = 0; i_191 < cl_19.variables.length; i_191++) {
      var pvar_24 = cl_19.variables[i_191];
    ...
    wr_12.indent(-1);
    wr_12.out("}", true);
    for ( var i_194 = 0; i_194 < cl_19.defined_variants.length; i_194++) {
      var fnVar_13 = cl_19.defined_variants[i_194];
      var mVs_13 = cl_19.method_variants[fnVar_13]
      for ( var i_201 = 0; i_201 < mVs_13.variants.length; i_201++) {
        var variant_28 = mVs_13.variants[i_201];
        wr_12.out("", true);
    ...
    wr_12.indent(-1);
    wr_12.out("}", true);
    for ( var i_200 = 0; i_200 < cl_19.static_methods.length; i_200++) {
      var variant_33 = cl_19.static_methods[i_200];
      wr_12.out("", true);
      if ( variant_33.nameNode.hasFlag("main") ) {
        continue;
      } else {
    ...
    for ( var i_203 = 0; i_203 < cl_19.static_methods.length; i_203++) {
      var variant_36 = cl_19.static_methods[i_203];
      ctx.disableCurrentClass();
      wr_12.out("", true);
...
class RangerRangerClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRefWithOpt(node ,ctx ,wr ) {
    ...
    var some_set = false
    for ( var i_187 = 0; i_187 < flags.length; i_187++) {
      var flag_2 = flags[i_187];
  ...
  writeFnCall(node ,ctx ,wr ) {
    if ( node.hasFnCall ) {
      ...
      ctx.setInExpr();
      for ( var i_190 = 0; i_190 < node.fnDesc.params.length; i_190++) {
        var arg_34 = node.fnDesc.params[i_190];
        if ( i_190 > 0 ) {
          wr.out(", ", false);
        }
        if ( (givenArgs_13.children.length) <= i_190 ) {
        ...
        var n_19 = givenArgs_13.children[i_190]
  ...
  writeNewCall(node ,ctx ,wr ) {
    if ( node.hasNewOper ) {
      ...
      if ( typeof(constr_24) !== "undefined" ) {
        for ( var i_192 = 0; i_192 < constr_24.params.length; i_192++) {
          var arg_37 = constr_24.params[i_192];
          var n_22 = givenArgs_16.children[i_192]
          if ( i_192 > 0 ) {
            wr.out(" ", false);
          }
  ...
  writeArgsDef(fnDesc ,ctx ,wr ) {
    for ( var i_194 = 0; i_194 < fnDesc.params.length; i_194++) {
      var arg_39 = fnDesc.params[i_194];
      if ( i_194 > 0 ) {
        wr.out(",", false);
      }
      wr.out(" ", false);
  ...
  writeClass(node ,ctx ,orig_wr ) {
    ...
    if ( (cl_23.extends_classes.length) > 0 ) {
      ...
      for ( var i_196 = 0; i_196 < cl_23.extends_classes.length; i_196++) {
        var pName_11 = cl_23.extends_classes[i_196];
    ...
    for ( var i_200 = 0; i_200 < cl_23.variables.length; i_200++) {
      var pvar_21 = cl_23.variables[i_200];
    ...
    for ( var i_203 = 0; i_203 < cl_23.static_methods.length; i_203++) {
      var variant_31 = cl_23.static_methods[i_203];
      wr_13.out("", true);
    ...
    for ( var i_206 = 0; i_206 < cl_23.defined_variants.length; i_206++) {
      var fnVar_14 = cl_23.defined_variants[i_206];
      var mVs_14 = cl_23.method_variants[fnVar_14]
      for ( var i_213 = 0; i_213 < mVs_14.variants.length; i_213++) {
        var variant_36 = mVs_14.variants[i_213];
        wr_13.out("", true);
        wr_13.out("fn ", false);
    ...
    for ( var i_212 = 0; i_212 < import_list_4.length; i_212++) {
      var codeStr_4 = import_list_4[i_212];
...
class LiveCompiler  {
  ...
  EncodeString(node ,ctx ,wr ) {
    ...
    while (ii_12 < str_length_3) {
      var ch_6 = node.string_value.charCodeAt(ii_12 )
      var cc_20 = ch_6
      switch (cc_20 ) { 
        case 8 : 
  ...
  CreateLambda(node ,ctx ,wr ) {
    ...
    wr.out("(", false);
    for ( var i_197 = 0; i_197 < args_6.children.length; i_197++) {
      var arg_37 = args_6.children[i_197];
      if ( i_197 > 0 ) {
        wr.out(", ", false);
      }
    ...
    wr.indent(1);
    wr.out("// body ", true);
    for ( var i_202 = 0; i_202 < body_2.children.length; i_202++) {
      var item_9 = body_2.children[i_202];
      this.WalkNode(item_9, ctx, wr);
    }
    wr.newline();
    wr.indent(-1);
  ...
  findOpCode(op ,node ,ctx ,wr ) {
    ...
    if ( (op.children.length) > 3 ) {
      ...
      for ( var i_202 = 0; i_202 < details.children.length; i_202++) {
        var det_2 = details.children[i_202];
          ...
          if ( fc_42.vref == "code" ) {
            ...
            if ( false == (typeof(stdClass.defined_static_methods[stdFnName] ) != "undefined") ) {
              ...
              for ( var ii_15 = 0; ii_15 < args_9.children.length; ii_15++) {
                var arg_40 = args_9.children[ii_15];
              ...
              if ( err_delta > 0 ) {
                ...
                for ( var i_216 = 0; i_216 < ctx.compilerErrors.length; i_216++) {
                  var e_21 = ctx.compilerErrors[i_216];
                  if ( i_216 < err_cnt_4 ) {
                    continue;
                  }
            ...
            if ( b_failed ) {
              ...
              for ( var i_224 = 0; i_224 < node.children.length; i_224++) {
                var cc_23 = node.children[i_224];
                if ( i_224 == 0 ) {
                  continue;
                }
                if ( i_224 > 1 ) {
  ...
  findOpTemplate(op ,node ,ctx ,wr ) {
    ...
    if ( (op.children.length) > 3 ) {
      ...
      for ( var i_208 = 0; i_208 < details_4.children.length; i_208++) {
        var det_5 = details_4.children[i_208];
        if ( (det_5.children.length) > 0 ) {
          var fc_45 = det_5.children[0]
          if ( fc_45.vref == "templates" ) {
            var tplList_2 = det_5.children[1]
            for ( var i_220 = 0; i_220 < tplList_2.children.length; i_220++) {
              var tpl_3 = tplList_2.children[i_220];
  ...
  WalkNode(node ,ctx ,wr ) {
    ...
    if ( node.expression ) {
      for ( var i_212 = 0; i_212 < node.children.length; i_212++) {
        var item_12 = node.children[i_212];
        if ( (node.didReturnAtIndex >= 0) && (node.didReturnAtIndex < i_212) ) {
          break;
        }
  ...
  walkCommandList(cmd ,node ,ctx ,wr ) {
    ...
    for ( var i_214 = 0; i_214 < cmd.children.length; i_214++) {
      var c_12 = cmd.children[i_214];
      ...
      switch (cmdE.vref ) { 
        ...
        case "cc" : 
          ...
          if ( (node.children.length) > idx_17 ) {
            ...
            var cc_25 = arg_50.string_value.charCodeAt(0)
            wr.out("" + (cc_25), false);
          }
          break;
        case "java_case" : 
          ...
          if ( (node.children.length) > idx_22 ) {
            ...
            this.WalkNode(arg_55, ctx, wr);
            if ( arg_55.didReturnAtIndex < 0 ) {
              wr.newline();
              wr.out("break;", true);
            }
          }
        ...
        case "goset" : 
          ...
          if ( (node.children.length) > idx_32 ) {
            ...
            ctx.setInExpr();
            this.langWriter.WriteSetterVRef(arg_65, ctx, wr);
            ctx.unsetInExpr();
          }
          break;
        case "pe" : 
        ...
        case "ptr" : 
          ...
          if ( (node.children.length) > idx_42 ) {
            ...
            if ( arg_75.hasParamDesc ) {
              if ( arg_75.paramDesc.nameNode.isAPrimitiveType() == false ) {
                wr.out("*", false);
              }
            } else {
              if ( arg_75.isAPrimitiveType() == false ) {
                wr.out("*", false);
              }
            }
          }
        ...
        case "ptrsrc" : 
          ...
          if ( (node.children.length) > idx_47 ) {
            ...
            if ( (arg_80.isPrimitiveType() == false) && (arg_80.isPrimitive() == false) ) {
              wr.out("&", false);
            }
          }
          break;
        ...
        case "list" : 
          ...
          if ( (node.children.length) > idx_57 ) {
            ...
            for ( var i_216 = 0; i_216 < arg_90.children.length; i_216++) {
              var ch_9 = arg_90.children[i_216];
              if ( i_216 > 0 ) {
                wr.out(" ", false);
              }
              ctx.setInExpr();
        ...
        case "comma" : 
          ...
          if ( (node.children.length) > idx_62 ) {
            ...
            for ( var i_224 = 0; i_224 < arg_95.children.length; i_224++) {
              var ch_17 = arg_95.children[i_224];
              if ( i_224 > 0 ) {
                wr.out(",", false);
              }
              ctx.setInExpr();
        ...
        case "swift_rc" : 
          ...
          if ( (node.children.length) > idx_67 ) {
            ...
            if ( arg_100.hasParamDesc ) {
              if ( arg_100.paramDesc.ref_cnt == 0 ) {
                wr.out("_", false);
              } else {
                wr.out(arg_100.vref, false);
              }
            } else {
              wr.out(arg_100.vref, false);
            }
        ...
        case "r_ktype" : 
          ...
          if ( (node.children.length) > idx_72 ) {
            ...
            if ( arg_105.hasParamDesc ) {
              var ss = this.langWriter.getObjectTypeString(arg_105.paramDesc.nameNode.key_type, ctx)
              wr.out(ss, false);
            } else {
              var ss_17 = this.langWriter.getObjectTypeString(arg_105.key_type, ctx)
              wr.out(ss_17, false);
            }
          }
          break;
        case "r_atype" : 
          ...
          if ( (node.children.length) > idx_77 ) {
            ...
            if ( arg_110.hasParamDesc ) {
              var ss_15 = this.langWriter.getObjectTypeString(arg_110.paramDesc.nameNode.array_type, ctx)
              wr.out(ss_15, false);
            } else {
              var ss_27 = this.langWriter.getObjectTypeString(arg_110.array_type, ctx)
              wr.out(ss_27, false);
            }
          }
          break;
        ...
        case "arraytype" : 
          ...
          if ( (node.children.length) > idx_82 ) {
            ...
            if ( arg_115.hasParamDesc ) {
              this.langWriter.writeArrayTypeDef(arg_115.paramDesc.nameNode, ctx, wr);
            } else {
              this.langWriter.writeArrayTypeDef(arg_115, ctx, wr);
            }
          }
          break;
        case "rawtype" : 
          ...
          if ( (node.children.length) > idx_87 ) {
            ...
            if ( arg_120.hasParamDesc ) {
              this.langWriter.writeRawTypeDef(arg_120.paramDesc.nameNode, ctx, wr);
            } else {
              this.langWriter.writeRawTypeDef(arg_120, ctx, wr);
            }
          }
          break;
        case "macro" : 
        ...
        case "typeof" : 
          ...
          if ( (node.children.length) >= idx_92 ) {
            ...
            if ( arg_125.hasParamDesc ) {
              this.writeTypeDef(arg_125.paramDesc.nameNode, ctx, wr);
            } else {
              this.writeTypeDef(arg_125, ctx, wr);
            }
          }
          break;
        case "imp" : 
        ...
        case "atype" : 
          ...
          if ( (node.children.length) >= idx_97 ) {
            ...
            var p_74 = this.findParamDesc(arg_130, ctx, wr)
  ...
  findParamDesc(obj ,ctx ,wr ) {
    ...
    if ( obj.vref != "this" ) {
      if ( (obj.ns.length) > 1 ) {
        ...
        var classRefDesc_3
        for ( var i_220 = 0; i_220 < obj.ns.length; i_220++) {
          var strname_3 = obj.ns[i_220];
          if ( i_220 == 0 ) {
            if ( strname_3 == "this" ) {
              classDesc_4 = ctx.getCurrentClass();
              if ( set_nsp_2 ) {
...
CompilerInterface.displayCompilerErrors = function(appCtx ) {
  for ( var i_214 = 0; i_214 < appCtx.compilerErrors.length; i_214++) {
    var e_22 = appCtx.compilerErrors[i_214];
...
CompilerInterface.displayParserErrors = function(appCtx ) {
  ...
  for ( var i_216 = 0; i_216 < appCtx.parserErrors.length; i_216++) {
    var e_25 = appCtx.parserErrors[i_216];
...
if ( ((process.argv.length - 2 - process.execArgv.length)) < 5 ) {
  console.log("Ranger compiler, version 2.0.6")
...
var wr_21 = file_5.getWriter()
var lcc_2 = new LiveCompiler()
var staticMethods
var importFork_8 = wr_21.fork()
for ( var i_209 = 0; i_209 < appCtx_2.definedClassList.length; i_209++) {
  var cName_2 = appCtx_2.definedClassList[i_209];
  ...
  lcc_2.WalkNode(cl_22.classNode, appCtx_2, wr_21);
}
if ( typeof(staticMethods) !== "undefined" ) {
  lcc_2.WalkNode(staticMethods.classNode, appCtx_2, wr_21);
}
var import_list_5 = wr_21.getImports()
...
for ( var i_216 = 0; i_216 < import_list_5.length; i_216++) {
  var codeStr_5 = import_list_5[i_216];
